                      ...
                      <div className="navbar8-menu-item">
                        ...
                        <div className="navbar8-content">
                          <span>
                            {props.page1 ?? (
                              <fragment>
                                <span className="navbar8-text03 thq-body-large">
                                  Home
                                </span>
                              </fragment>
                            )}
                            ...
                            {props.page1Description ?? (
                              <fragment>
                                <span className="navbar8-text07 thq-body-small">
                                  Welcome to Little Tigers Foundation - Your
                            ...
                            {props.page2Description ?? (
                              <fragment>
                                <span className="navbar8-text02 thq-body-small">
                                  Learn more about Little Tigers Foundation and
                                  our mission
                                </span>
                              </fragment>
                            )}
                            ...
                            {props.page3Description ?? (
                              <fragment>
                                <span className="navbar8-text09 thq-body-small">
                                  Join our online or local support groups for
                                  teenagers, parents, health professionals, and
                                  educators
                                </span>
                              </fragment>
                            )}
            ...
            <div className="navbar8-buttons1">
              <button className="thq-button-filled">
                <span>
                  {props.action1 ?? (
                    <fragment>
                      <span className="navbar8-text11">Main Action</span>
                    </fragment>
                  )}
                </span>
              </button>
                  ...
                  <div className="navbar8-content4">
                    ...
                    <span>
                      {props.page1Description ?? (
                        <fragment>
                          <span className="navbar8-text07 thq-body-small">
                            Welcome to Little Tigers Foundation - Your mental
                  ...
                  <div className="navbar8-content5">
                    ...
                    <span>
                      {props.page2Description ?? (
                        <fragment>
                          <span className="navbar8-text02 thq-body-small">
                            Learn more about Little Tigers Foundation and our
                            mission
                          </span>
                        </fragment>
                      )}
...
Navbar8.defaultProps = {
  page3ImageAlt: 'Image representing Support Groups page',
  page4ImageSrc:
  ...
  logoAlt: 'Little Tigers Foundation Logo',
  linkUrlPage3: '#',
  link3Url: '#',
  link1Url: '#',
  page4: undefined,
  page2ImageAlt: 'Image representing About Us page',
