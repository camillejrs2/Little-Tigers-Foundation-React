        ...
        <div className="pricing14-section-title">
          ...
          <div className="pricing14-content">
            <h2>
              {props.heading1 ?? (
                <fragment>
                  <span className="pricing14-text058 thq-heading-2">
                    Pricing plan
                  </span>
                </fragment>
              )}
            ...
            <p>
              {props.content2 ?? (
                <fragment>
                  <span className="pricing14-text069 thq-body-large">
                    <span>
              ...
              <div className="pricing14-price">
                <div className="pricing14-price01">
                  ...
                  <h3>
                    {props.plan1Price ?? (
                      <fragment>
                        <span className="pricing14-text074 thq-heading-3">
                          Free
                        </span>
                      </fragment>
                    )}
                      ...
                      {props.plan1Feature2 ?? (
                        <fragment>
                          <span className="pricing14-text102 thq-body-small">
                            Access to local, in-person support groups
                          </span>
                        </fragment>
                      )}
                    </span>
                      ...
                      {props.plan1Feature3 ?? (
                        <fragment>
                          <span className="pricing14-text055 thq-body-small">
                            Receive regular updates and resources
                          </span>
                        </fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price02">
                <div className="pricing14-price03">
                  ...
                  <h3>
                    {props.plan2Price ?? (
                      <fragment>
                        <span className="pricing14-text086 thq-heading-3">
                          $9.99/month
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price04">
                <div className="pricing14-price05">
                  ...
                  <h3>
                    {props.plan3Price ?? (
                      <fragment>
                        <span className="pricing14-text097 thq-heading-3">
                          $19.99/month
                        </span>
                      </fragment>
                    )}
                      ...
                      {props.plan3Feature2 ?? (
                        <fragment>
                          <span className="pricing14-text077 thq-body-small">
                            24/7 access to crisis helpline
                          </span>
                        </fragment>
                      )}
                    </span>
              ...
              <div className="pricing14-price06">
                <div className="pricing14-price07">
                  ...
                  <h3>
                    {props.plan1Price1 ?? (
                      <fragment>
                        <span className="pricing14-text062 thq-heading-3">
                          $200/yr
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price08">
                <div className="pricing14-price09">
                  ...
                  <h3>
                    {props.plan2Price1 ?? (
                      <fragment>
                        <span className="pricing14-text092 thq-heading-3">
                          $299/yr
                        </span>
                      </fragment>
                    )}
              ...
              <div className="pricing14-price10">
                <div className="pricing14-price11">
                  ...
                  <h3>
                    {props.plan3Price1 ?? (
                      <fragment>
                        <span className="pricing14-text094 thq-heading-3">
                          $499/yr
                        </span>
                      </fragment>
                    )}
