      ...
      <div className="hero17-column thq-section-max-width thq-section-padding">
        <div className="hero17-content">
          <h1>
            {props.heading1 ?? (
              <fragment>
                <span className="hero17-text6 thq-heading-1">
...
Hero17.defaultProps = {
  ...
  image11Alt: 'Supportive online community sharing resources',
  image7Alt: 'Teenager expressing emotions in a safe space',
  image5Src:
  ...
  content1: undefined,
  image10Alt: 'Educator interacting with students in a classroom',
  image12Alt: 'Local support group members offering each other encouragement',
  action1: undefined,
  heading1: undefined,
  image6Src:
  ...
  image9Alt: 'Health professional listening attentively to a patient',
  image10Src:
  ...
  image8Alt: 'Parent reading a book with their young child',
  image1Alt: 'Group of diverse teenagers supporting each other',
  image9Src:
  ...
  image3Alt: 'Health professional providing care and support',
  image2Alt: 'Parent and child engaging in a positive activity together',
  image4Src:
  ...
  image6Alt: 'Local in-person support group gathering in a park',
  image12Src:
  ...
  image4Alt: 'Educator teaching a group of students',
  image5Alt: 'Online support group meeting via video call',
}
